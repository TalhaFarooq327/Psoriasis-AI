  ...
  return (
    <>
      <div className="sa-header">
        ...
        <p className="sa-header__desc">
          Our deep-learning model is examining your image across 120K+ training samples.
        </p>
      </div>
...
ANALYSIS TIME: 1.5s
MODEL:         ML Model (final_model.keras)
        ...
        <div className="sa-confidence-card">
          ...
          <div className="sa-conf-info">
            ...
            <p>
              ...
              This is based on pattern matching across 120K+ dermatology images.
            </p>
